...
{
    class ObjectGroupResourceView : IResourceView, IDeletable
    {
        string name = "new group";
        public ObjectGroupResourceView() { }
        ...
        public void Delete()
        {
            if (MessageBox.Show(string.Format("Are you sure you want to permanently delete all of the objects in the group '{0}'?", name), "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                DoDelete(true);
        }

        public string InsertString
        {
            get { return "Create Object"; }
        }
        ...
        {
            Program.IDE.AddResource(Node, new ObjectGroupResourceView(), null, -1, true, true, false);
        }
