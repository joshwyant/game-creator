...
{
    class FontGroupResourceView : IResourceView, IDeletable
    {
        string name = "new group";
        public FontGroupResourceView() { }
        ...
        public void Delete()
        {
            if (MessageBox.Show(string.Format("Are you sure you want to permanently delete all of the fonts in the group '{0}'?", name), "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                DoDelete(true);
        }
