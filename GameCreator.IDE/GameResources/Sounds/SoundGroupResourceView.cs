...
{
    class SoundGroupResourceView : IResourceView, IDeletable
    {
        string name = "new group";
        public SoundGroupResourceView() { }
        ...
        public void Delete()
        {
            if (MessageBox.Show(string.Format("Are you sure you want to permanently delete all of the sounds in the group '{0}'?", name), "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                DoDelete(true);
        }

        public string InsertString
        {
            get { return "Create Sound"; }
        }
        ...
        {
            Program.IDE.AddResource(Node, new SoundGroupResourceView(), null, -1, true, true, false);
        }
