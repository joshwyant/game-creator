...
{
    class TimeLineGroupResourceView : IResourceView, IDeletable
    {
        string name = "new group";
        public TimeLineGroupResourceView() { }
        ...
        public void Delete()
        {
            if (MessageBox.Show(string.Format("Are you sure you want to permanently delete all of the time lines in the group '{0}'?", name), "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                DoDelete(true);
        }
